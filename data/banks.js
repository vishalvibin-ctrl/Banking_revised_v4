...
export const ALL_BANKS = [
  ...
  { id:"alhilal", name:"Al Hilal Bank", color:"#8B6914", type:"Islamic", category:"digital", hq:"Abu Dhabi", exchange:"ADCB subsidiary", est:2007, profit2025:-0.12, profit2024:-0.12, totalAssets:13.6, yoyGrowth:0, roe:0, nplRatio:5.0, grossLoans:8, nplPrior:6.0, coverageRatio:70, retailLoans:8, corpLoans:0, customerDeposits:9.3, totalEquity:1.1, impairmentCharge:0.14, operatingIncome:0.42, status:"reported", period:"FY2025 reported", sourceNote:"ADCB group disclosure", featured:true, hasProducts:true, note:"Loss-making", irUrl:"https://www.alhilalbank.ae/en/about-us/investor-relations", q1Status:"pending", q1Period:"Q1 2026 not yet reported" },
